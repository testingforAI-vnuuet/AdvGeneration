...
Original file is located at
    https://colab.research.google.com/drive/1-Ym6I-P-p7i9cRUDSkENKlbHUenKo7af
"""
...
#     '/content/drive/MyDrive/N12-Kĩ thuật giấu tin/CSV/4 patterns/4m9 records/.TRAIN_4_PATTERN_3.932.803.csv')
# data_test = pd.read_csv(
#     '/content/drive/MyDrive/N12-Kĩ thuật giấu tin/CSV/4 patterns/4m9 records/.TEST_4_PATTERN_983.201.csv')
# # ip.id max = 65535
...
data_test = pd.read_csv(
    'data/test.csv')
trainY = data_train.iloc[:3932803, 0].values
