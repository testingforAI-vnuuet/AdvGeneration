...
class AutoencoderBorder:
    ...
    def get_border_and_adv(self):
        ...
        self.smooth_adv = smooth_adv_border_V2(self.classifier, self.adv_result[:10], self.origin_adv_result[:10], get_border(self.origin_adv_result[:10]), self.target_label)
        self.end_time = time.time()
